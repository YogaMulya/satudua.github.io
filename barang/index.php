...
<br><br>
	...
	if( isset( $_REQUEST['login'] ) ){
		...
		$sql = mysqli_query($koneksi, "SELECT id_user, username, nama, level , koordinator FROM user WHERE username='$username' AND password='$password'");

        
		if( $sql){
			list($id_user, $username, $nama, $level, $koordinator) = mysqli_fetch_array($sql);
      $_SESSION['id_user'] = $id_user;
			$_SESSION['username'] = $username;
			$_SESSION['nama'] = $nama;
			$_SESSION['koordinator'] = $koordinator;
